...
- voice preset browser の検索 / category・tag filter / 最近使用履歴
- voice preset の import / export と built-in / user preset 適用
...
Torus Edison v0.3.1 は MIT License で提供します。詳細は [LICENSE.md](LICENSE.md) を確認してください。
