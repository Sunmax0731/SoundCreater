...
- preset browser で検索、category / tag filter、最近使用履歴、user preset file の警告表示を利用可能
...
- Voice Preset browser / import / export
...
- Unity `6000.4.0f1` / Windows で EditMode tests を実行し、`Total=129 Passed=129 Failed=0 Skipped=0` を確認済み
