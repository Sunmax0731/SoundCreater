...
namespace TorusEdison.Editor.Localization
{
    internal static class GameAudioLocalization
    {
        ...
        private static readonly IReadOnlyDictionary<string, string> Japanese = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["timeline.bars"] = "Bars",
            ["timeline.decreaseBars"] = "Bars を減らす",
            ["timeline.increaseBars"] = "Bars を増やす",
            ["timeline.lengthHelp"] = "ここにある Bars 操作、Settings の Total Bars、またはタイムライン右端のドラッグでプロジェクト長を変更できます。",
            ...
            ["status.timelineHint"] = "グリッド {0} | 選択ノート {1} 個 | 空レーンのドラッグで作成 | ノートのドラッグで移動 | ノート端でリサイズ | タイムライン右端ドラッグで Bars 変更 | Ctrl+D で複製 | Delete で選択ノートまたは選択トラックを削除 | Ctrl+Z / Ctrl+Y で Undo / Redo",
        ...
        private static readonly IReadOnlyDictionary<string, string> Chinese = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["timeline.grid"] = "网格 {0}",
            ["timeline.bars"] = "Bars",
            ["timeline.decreaseBars"] = "减少 Bars",
            ["timeline.increaseBars"] = "增加 Bars",
            ["timeline.lengthHelp"] = "可使用此处的 Bars 控件、Settings 中的 Total Bars，或拖拽时间线右边缘来更改项目长度。",
            ...
            ["status.timelineHint"] = "网格 {0} | 已选音符 {1} 个 | 拖拽空白轨道创建 | 拖拽音符移动 | 拖拽音符边缘调整长度 | 拖拽时间线右边缘更改 Bars | Ctrl+D 复制 | Delete 删除所选音符或所选轨道 | Ctrl+Z / Ctrl+Y 撤销 / 重做",
